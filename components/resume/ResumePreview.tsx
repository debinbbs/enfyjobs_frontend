...
export function ResumePreview({
  ...
  return (
    <div className="flex flex-col bg-slate-100/50 p-6 sticky top-[130px] h-fit rounded-[3rem] border border-white/40 shadow-2xl animate-in fade-in slide-in-from-right-8 duration-1000">
      <div className="mb-4 flex justify-between items-center text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">
        <div className="flex items-center gap-2">
           <div className="size-2 rounded-full bg-secondary-container animate-pulse" />
      ...
      {/* Resume Canvas */}
      <div className="bg-white rounded-[2.5rem] shadow-xl flex flex-col overflow-visible">
        {/* Editorial Header */}
          ...
          <main className="col-span-8 p-10 space-y-12">
            <section className="space-y-4">
              ...
              <p className="text-[13px] font-medium text-slate-600 leading-relaxed italic pr-4">
                "To harmonize modern corporate performance with ancient spiritual grounding, creating high-frequency workspaces where employees thrive through conscious movement and breath."
              </p>
            </section>
