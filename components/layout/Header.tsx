    ...
    `}>
      <div className="flex items-center gap-12">
        ...
        <nav className="hidden lg:flex items-center gap-8">
          <a className="text-sm font-semibold hover:text-primary transition-colors" href="#">Jobs</a>
          <a className="text-sm font-semibold hover:text-primary transition-colors" href="#">AI Resume</a>
          <a className="text-sm font-semibold hover:text-primary transition-colors" href="#">Interview Prep</a>
          <a className="text-sm font-semibold hover:text-primary transition-colors" href="#">Upskill</a>
        </nav>
      </div>
